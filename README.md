# hyperbolicfitdll
 ...
 The new versions of the library contain an image class which can be constructed from a pathto a fits file, a fits file structure or an array with image data.
